...
import com.openbox.realcomm.utilities.helpers.CustomAnimationListener;
	...
	ClearFocusInterface
{
	...
	public Animation onCreateAnimation(int transit, boolean enter, int nextAnim)
	{
		...
		// if (getIsVisible() && getParentFragment() != null && this instanceof BaseProfileFragment)
		// {
	...
	/**********************************************************************************************
	 * ANDROID BUG FIX - If a parent fragment is hidden, the child incorrectly still reports being visible
	 **********************************************************************************************/
